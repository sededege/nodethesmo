...
const Crater = () => {
  ...
  const [CrateData, setCrateData] = useState(true);
  ...
  const url = "http://localhost:3003/api/crates";
  ...
  const Form = () => {
    ...
    const getCrate = (req, res) => {
      
        fetch('http://localhost:3003/api/crates')
          .then(response => {
            res.statusCode = 200
  ...
  useEffect(() => {
    ...
    // await fetch('http://localhost:3001/api/crates')
    //   .then((res) => res.json())
    //   .then((data) => {
    //     setCrateData(data)
    //     console.log(data)
    ...
    <div className="h-[90vh] mt-[10vh] md:mt-0 md:h-[82vh] overflow-auto pb-10 w-full px-4 md:px-20 ">
      ...
      <div className="flex w-full ">
        <div className="w-full ">
          ...
          <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 w-full mt-2 ">
            {/*  <Cardtweet /> */}
...
{/* {ccdata.map((item) => (
 ...
 {/* <div className="gap-2 flex w-full"> <button className="bg-btn
 text-white p-2 rounded-lg">-</button> <input className="w-
 [60px] text-center bg-transparent border-2 border-slate-500
 rounded-lg text-white mx-auto" type="text" />
         <button className="bg-btn text-white p-2 rounded-lg">+</button>
         <button className="bg-yellow-300 text-tesmo font-semibold hover:bg-tesmo2 border-2 border-yellow-300 hover:border-tesmo2 hover:text-white w-full rounded-lg text-center p-2 cursor-pointer"
       >
         Buy tickets
       </button>
       </div> */}
