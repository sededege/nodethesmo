...
const Cratereward = ({ id, pointsuser, upd, number }) => {
  ...
  <div>
  <a href="" class="card">
    <img src="/ArtStation - Explore.jpeg" class="card__image" alt="" />
    <div class="card__overlay">
      <div class="card__header">
        <svg class="card__arc" xmlns="http://www.w3.org/2000/svg"><path /></svg>                     
        {/* <img class="card__thumb" src="https://i.imgur.com/7D7I6dI.png" alt="" /> */}
        <div class="card__header-text">
          <h3 class="card__title">Sapphire</h3>            
...
<div>
  <a href="" class="card">
    <img src="/Treasure Chest, Betty Jiang.jpeg" class="card__image" alt="" />
    <div class="card__overlay">        
      <div class="card__header">
        <svg class="card__arc" xmlns="http://www.w3.org/2000/svg"><path /></svg>                 
        ...
        <div class="card__header-text">
          <h3 class="card__title">Sapphire</h3>
          <span class="card__status">10 Points</span>
        </div>
      </div>
      <p class="card__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores, blanditiis?</p>
    </div>
...
<div>
  <a href="" class="card">
    <img src="/png" class="card__image" alt="" />
    <div class="card__overlay">
      <div class="card__header">
        <svg class="card__arc" xmlns="http://www.w3.org/2000/svg"><path /></svg>                     
        <img class="card__thumb" src="https://i.imgur.com/7D7I6dI.png" alt="" />
