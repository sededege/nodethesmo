...
//     const db = client.db("Thesmo").collection("Crates")
//     const lotteryData = await db.find({}).toArray();  
//     console.log("Index: " + lotteryData)
...
<p>{usr[0].points}</p>
        ...
        <p className="description bg-slate-900">
          <img src='/ThesmoLogo.png' />
        </p>
